...
class Orders(models.Model):
    ...
    educational_form = models.ForeignKey('EducationalForm', on_delete=models.PROTECT, related_name='linked_orders', verbose_name='Форма обучения')
...
class Result(models.Model):
    ...
    educational_form = models.ForeignKey('EducationalForm', on_delete=models.PROTECT, related_name='linked_results', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
...
class RecommendedList(models.Model):
    ...
    educational_form = models.ForeignKey('EducationalForm', on_delete=models.PROTECT, related_name='linked_rec_list', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_order = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class OrdersMag(models.Model):
    ...
    name_order = models.CharField(max_length=256, verbose_name='Название')
    number_order = models.CharField(max_length=64, verbose_name='Номер документа')
    educational_form = models.ForeignKey('EducationalFormMag', on_delete=models.PROTECT, related_name='linked_orders', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_order = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class ResultMag(models.Model):
    ...
    name_result = models.CharField(max_length=256, verbose_name='Название')
    number_result = models.CharField(max_length=64, verbose_name='Номер документа')
    educational_form = models.ForeignKey('EducationalFormMag', on_delete=models.PROTECT, related_name='linked_results', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_result = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class RecommendedListMag(models.Model):
    ...
    name_rec_list = models.CharField(max_length=256, verbose_name='Название')
    educational_form = models.ForeignKey('EducationalFormMag', on_delete=models.PROTECT, related_name='linked_rec_list', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_order = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class OrdersAsp(models.Model):
    ...
    name_order = models.CharField(max_length=256, verbose_name='Название')
    number_order = models.CharField(max_length=64, verbose_name='Номер документа')
    educational_form = models.ForeignKey('EducationalFormAsp', on_delete=models.PROTECT, related_name='linked_orders', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_order = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class ResultAsp(models.Model):
    ...
    name_result = models.CharField(max_length=256, verbose_name='Название')
    number_result = models.CharField(max_length=64, verbose_name='Номер документа')
    educational_form = models.ForeignKey('EducationalFormAsp', on_delete=models.PROTECT, related_name='linked_results', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_result = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
...
class RecommendedListAsp(models.Model):
    ...
    name_rec_list = models.CharField(max_length=256, verbose_name='Название')
    educational_form = models.ForeignKey('EducationalFormAsp', on_delete=models.PROTECT, related_name='linked_rec_list', verbose_name='Форма обучения')
    date_pub = models.DateTimeField(auto_now_add=True)
    date_order = models.DateField(verbose_name='Дата создания приказа')
    file = models.FileField(upload_to='files', verbose_name='Файл')
